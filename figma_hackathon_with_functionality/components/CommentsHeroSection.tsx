                ...
                <Card>
                  <CardContent className="flex flex-col aspect-square items-start justify-start p-6 gap-2">
                    ...
                    <div className="flex flex-col gap-2">
                      <h1 className="text-[22px] font-bold text-start">
                        {comment.name}
                      </h1>
                      <p className="text-[14px] font-medium text-muted-foreground dark:text-muted-foreground text-start">
                        {comment.designation}
                      </p>
                      <p className="text-[16px] font-normal  line-clamp-2 text-start">
                        {comment.comment}
                      </p>
                    </div>
                    <div className="flex flex-col gap-2">
                      <p className="text-[16px] font-medium text-primary dark:text-primary text-start">Car used {comment.carName}
                      </p>
                      ...
                      <div className='flex gap-1 justify-start items-center text-start'>
